...
the stable stage distribution is: $[0.312, 0.688]^T$, which means that when the population has 31.2% young-of-the-year frogs, and 68.8% frogs one year or older, each year both age classes will increase by a fixed amount which is the dominant eigenvalue that you calculated for yesterday's question 1.
...
b. Calculate the increase from $t$ to $t+1$ for both stages, i.e., $f_1 = N_{1,t+1}/31.2$ and $f_2 = N_{2,t+1}/68.8$. How do $f_1$ and $f_2$ compare to the dominant eigenvalue that you calculated for yesterday's question 1? [2 marks]
