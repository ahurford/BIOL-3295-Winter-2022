...
1. What are 2-3 key references relevant to your topic (please use the _American Naturalist_ citation format as described in the Final project description, see )? [5 marks]
...
1. Review paper only: what will be the sections of your review? Analysis only: what are the data sources that you will be using for your analysis? Describe the characteristics of the data. [1 mark]
